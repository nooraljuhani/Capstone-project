...
.bar-chart .eje-x li:nth-child(7):before {
 ...
 <h1 style="margin-left: 700px;margin-bottom: 40px;margin-top: 40px"> <i class="fa fa-user"></i>System report </h1>
  <?php  
...
<div class="container" style="margin-left: 300px">
  ...
  <div class="donut-chart-block block"> 
   <h1 class="titular mt-5">User in System</h1>
...
<p class="center-date">February<br><span class="scnd-font-color">2021</span></p>        
                    </div>
                    <ul class="os-percentages horizontal-list">
                        <li>
                            <p class="ios os scnd-font-color">Customer</p>
                            <p class="os-percentage"><?php echo $c[0]['count']?></p>
                        </li>
                        <li>
                            <p class="mac os scnd-font-color">Vendors</p>
                            <p class="os-percentage"><?php echo $v[0]['count']?></p>
                        </li>
                        <li>
                            <p class="linux os scnd-font-color">Product</p>
                            <p class="os-percentage"><?php echo $p[0]['count']?></p>
                        </li>
                        <li>
                            <p class="win os scnd-font-color">Category</p>
                            <p class="os-percentage"><?php echo $c[0]['count']?></p>
                        </li>
                    </ul>
                </div>
...
<div class="container" style="margin-left: 500px">
  ...
  <div class="donut-chart-block block" style="width: 380px"> 
   <h1 class="titular mt-5">TOP 5 Vendors</h1>
                    <div class="donut-chart">
     ...
     <div id="porcion3" class="recorte"><div class="quesito win" data-rel="31"></div></div>
     <div id="porcionFin" class="recorte"><div class="quesito linux" data-rel="9"></div></div>
<p class="center-date">TOP<br><span class="scnd-font-color">5</span></p>        
                    </div>
                    <ul class="os-percentages horizontal-list ">
          ...
          foreach ($value as $k => $u) {$row[$k]=$u;}

                    echo "<li>
              <p class='win os scnd-font-color'>{$row['ven_name']}</p> </li>";
                    $ci++;
                }
                    ?>
