                        ...
                        if ($data=$x->readByven($id)){
                                        ...
                                        foreach ($data as $key => $value) {
                                            foreach ($value as $k => $v) {$row[$k]=$v;}
                                                ...
                                                echo "<td><a href='vEdit_Product.php?id={$row['pro_id']}&ven_id={$row['ven_id']}' class='btn btn-warning'>Edit</a></td>";
                                                echo "<td><a href='vDelete_Product.php?id={$row['pro_id']}' class='btn btn-danger'>Delete</a></td>";
                                                echo "</tr>";
