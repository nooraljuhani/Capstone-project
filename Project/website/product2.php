...
<div class="p-b-5">
<div class="">
<div class="row hover-overlay " style="margin-left: 20px;width: 2700px">
...
<div class="row">
<?php
 $query  = "select * from product where $id=product.ven_id";
  $result = mysqli_query($conn,$query);
 while($row = mysqli_fetch_assoc($result)){
 	?>

<div class="block2-pic  p-t-14 p-l-50 ">
<?php echo"<img src='../Admin/image/{$row['image']}' width='250px' hight='200px'/><br>
<a href='product-detail1.php?id={$row['pro_id']}' class='block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 btn btn-outline-dark p-lr-15 trans-04' >
View-Detail
</a>";?>
